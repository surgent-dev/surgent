...
/**
 * Surgent Analytics Sample Data Generator
 *
 ...
 *
 * Usage:
 *   bun run seed-data              # Generate 30 days of data
 *   bun run seed-data -- --days 90 # Generate 90 days of data
 *   bun run seed-data -- --clear   # Clear existing demo data first
 *   bun run seed-data -- --verbose # Show detailed progress
 */
...
Examples:
  ...
  bun run seed-data -- --days 90      # Generate 90 days of data
  bun run seed-data -- --clear        # Clear existing demo data first
  bun run seed-data -- --days 7 -v    # Generate 7 days with verbose output
