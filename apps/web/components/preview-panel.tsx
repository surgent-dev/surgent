...
// Fun loading messages and icons with wild animations
type LoadingVibe = { message: string; icon: typeof Sparkle; animation: string }

const LOADING_VIBES: LoadingVibe[] = [
  {
    message: 'Manifesting...',
    icon: Sparkle,
...
// Loading spinner component with fun random animations
function LoadingState({
  ...
  const [vibe, setVibe] = useState<LoadingVibe>(LOADING_VIBES[0]!)

  useEffect(() => {
    setVibe(LOADING_VIBES[Math.floor(Math.random() * LOADING_VIBES.length)]!)
