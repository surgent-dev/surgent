      ...
      <PromptInput value={value} onValueChange={setValue} onSubmit={handleSend} className="w-full">
        ...
        <PromptInputActions className="pt-1.5 sm:pt-2">
          ...
          <div className="ml-auto flex items-center gap-1 sm:gap-1.5">
            <PromptInputAction tooltip={disabled || (!value.trim() && !files.length) ? "Type or attach" : "Send"}>
              <Button
                type="button"
                size="icon"
                onClick={handleSend}
                ...
                className={cn(
                  ...
                  disabled || (!value.trim() && !files.length) ? "opacity-50 cursor-not-allowed" : "cursor-pointer",
                )}
              >
