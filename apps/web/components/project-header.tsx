  ...
  const handleConfirmDeploy = useCallback(
    async (name: string) => {
      ...
      try {
        ...
        router.push(`/dashboard/deploymentboard?projectId=${projectId}`)
        setIsDeploying(false)
      }
    },
    [deployProject, isDeploying, projectId, router],
  )
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                ...
                {isCheckingAccess ? "Checking..." : isInProgress ? "Deploying..." : "Deploy"}
              </Button>
            </TooltipTrigger>
