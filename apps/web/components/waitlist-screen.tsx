      ...
      <div className="flex-1 flex flex-col p-8 md:p-12 lg:p-20 max-w-3xl mx-auto w-full justify-between">
        ...
        <footer className="mt-20 space-y-10">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-2 text-sm text-muted-foreground">
            ...
            <a href="https://x.com/benroff_" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">
              Twitter @benroff_
            </a>
            <a href="https://t.me/benrov" target="_blank" rel="noreferrer" className="hover:text-foreground transition-colors">
              Telegram @benrov
            </a>
          </div>
