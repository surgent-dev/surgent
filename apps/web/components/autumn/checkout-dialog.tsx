          ...
          <PopoverContent align="start" className="w-80 text-sm p-4 pt-3 flex flex-col gap-4">
            ...
            <div className="flex justify-between items-end">
              ...
              <Button
                ...
                disabled={loading}
              >
                {loading ? <Loader2 className="text-muted-foreground animate-spin w-4! h-4!" /> : "Save"}
              </Button>
            </div>
          </PopoverContent>
        </Popover>
...
export const PricingDialogButton = ({
  ...
  return (
    <Button onClick={onClick} disabled={disabled} size={size} className={cn(className, "shadow-sm shadow-stone-400")}>
      {children}
