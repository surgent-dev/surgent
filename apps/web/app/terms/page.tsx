        ...
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              By accessing and using Surgent, you accept and agree to be bound by the terms and provision of this
              agreement.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Surgent provides AI-powered website building tools. We reserve the right to modify or discontinue the
              service at any time.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Surgent shall not be liable for any indirect, incidental, special, consequential or punitive damages
