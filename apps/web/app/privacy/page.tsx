      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <p className="text-foreground/80 leading-relaxed mt-6">
            Benrov, Inc. (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates Surgent. This Privacy Policy
          ...
          <section className="mt-8">
            ...
            <ul className="text-foreground/80 leading-relaxed space-y-2">
              ...
              <li>
                <strong>User Content:</strong> Any content, data, or materials you create, upload, or generate using
                Surgent
              </li>
              <li>
            ...
            <ul className="text-foreground/80 leading-relaxed space-y-2">
              <li>
                <strong>Usage Data:</strong> How you interact with Surgent, features used, and actions taken
              </li>
              <li>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Content you create or input into Surgent may be processed by AI services to provide our features. We do
              not use your content to train AI models. Your content remains yours and is not shared with other users.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Your data is stored on secure servers in the United States. We implement industry-standard security
              measures including encryption in transit and at rest, regular security audits, and access controls.
          ...
          <section className="mt-8">
            ...
            <ul className="text-foreground/80 leading-relaxed space-y-2">
              <li>
                <strong>Authentication:</strong> Secure login providers
              </li>
              <li>
                <strong>AI Services:</strong> Large language model providers for content generation
              </li>
              <li>
              ...
              <li>
                <strong>Cloud Infrastructure:</strong> Data hosting and storage
              </li>
            </ul>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              can request deletion of your account and associated data at any time. Some information may be retained as
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              information we collect, request deletion, and opt-out of any sale of personal information. We do not sell
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Surgent is not intended for users under 13 years of age. We do not knowingly collect personal information
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              If you access Surgent from outside the United States, your information may be transferred to, stored, and
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              notice on Surgent or sending you an email. Your continued use after changes constitutes acceptance of the
              updated policy.
            </p>
          </section>
