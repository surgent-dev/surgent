      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <article className="prose prose-zinc dark:prose-invert max-w-none">
          ...
          <p className="text-foreground/80 leading-relaxed mt-6">
            Benrov, Inc. (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates Surgent. This
          ...
          <section className="mt-8">
            ...
            <ul className="text-foreground/80 leading-relaxed space-y-2">
              ...
              <li>
                <strong>User Content:</strong> Any content, data, or materials you create, upload,
                or generate using Surgent
              </li>
              <li>
            ...
            <ul className="text-foreground/80 leading-relaxed space-y-2">
              <li>
                <strong>Usage Data:</strong> How you interact with Surgent, features used, and
                actions taken
              </li>
              <li>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Content you create or input into Surgent may be processed by AI services to provide
              our features. We do not use your content to train AI models. Your content remains
              yours and is not shared with other users.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Your data is stored on secure servers in the United States. We implement
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              provide you services. You can request deletion of your account and associated data at
              any time. Some information may be retained as required by law or for legitimate
              business purposes.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              know what personal information we collect, request deletion, and opt-out of any sale
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              Surgent is not intended for users under 13 years of age. We do not knowingly collect
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              If you access Surgent from outside the United States, your information may be
              transferred to, stored, and processed in the United States. By using our service, you
          ...
          <section className="mt-8">
            ...
            <p className="text-foreground/80 leading-relaxed">
              ...
              changes by posting a notice on Surgent or sending you an email. Your continued use
