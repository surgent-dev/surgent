...
export async function up(db: Kysely<any>): Promise<void> {
  ...
  await db.schema
    ...
    .execute()
  await db.schema
    .createIndex('idx_checkout_session_org_id')
    .ifNotExists()
    .on('checkout_session')
    .column('organizationId')
    .execute()
  ...
  await db.schema
    .createIndex('idx_held_balance_org')
    .ifNotExists()
    .on('held_balance')
    .column('organizationId')
    .execute()
  ...
  await db.schema
    .createIndex('ix_payment_organization_id')
    .ifNotExists()
    .on('payment')
    .column('organizationId')
    .execute()
  ...
  await db.schema
    .createIndex('ix_dispute_organization_id')
    .ifNotExists()
    .on('dispute')
    .column('organizationId')
    .execute()
...
export async function down(db: Kysely<any>): Promise<void> {
  ...
  await db.schema.dropIndex('ix_dispute_organization_id').ifExists().execute()
  ...
  await db.schema.dropIndex('ix_payment_organization_id').ifExists().execute()
  ...
  await db.schema.dropIndex('idx_checkout_session_org_id').ifExists().execute()
